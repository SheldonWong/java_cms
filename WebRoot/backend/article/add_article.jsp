...
<div id="formwrapper">
	...
	<fieldset>
		...
		<div>
            <label >选择</label>
            <input type="checkbox" name="recommend" id="recommend" value="true"  />是否推荐阅读 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="checkbox" name="headline" id="headline" value="true"  /> 是否首页头条
        </div>
		<div>
		...
		<div>
            <label for="attchs">上传附件</label>
            <input type="file" name="attchs" id="attachs" />
            <br />  
        </div>
		<div class="enter">
