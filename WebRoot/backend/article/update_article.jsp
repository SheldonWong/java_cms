...
<div id="formwrapper">
	...
	<fieldset>
        ...
        <div>
            <label >选择</label>
            <input type="checkbox" name="recommend" id="recommend" value="true" <c:if test="${article.recommend }">checked ="checked"</c:if>  />是否推荐阅读 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="checkbox" name="headline" id="headline" value="true"  <c:if test="${article.headline }">checked ="checked"</c:if> /> 是否首页头条
        </div>
        <div>
