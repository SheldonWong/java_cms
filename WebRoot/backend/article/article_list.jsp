...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">http://www.gege.com</div></td>
        ...
        <a href="ArticleServlet?id=${a.id }&method=del" title="点击删除文章">删除</a> |
        <a href="ArticleServlet?id=${a.id }&method=updateInput" title="点击编辑文章">编辑</a>
        </div></td>
      </tr>
      </c:forEach>
      </c:if>
  ...
  <tr>
		...
		<jsp:include page="/backend/common/pager.jsp">
			<jsp:param value="ArticleServlet" name="url"/>
			<jsp:param value="title,content,createTime" name="searchParam"/>
		</jsp:include>		
	</td>
      </tr>
    </table></td>
